  ...
  <body>
    ...
    <section class="auth">
        <div class="container overflow-hidden">
            <h2 class="h2-123 d-flex justify-content-center">Добавление товара</h2>
            <form class="form-product d-flex justify-content-center" action="php/add.php" method="POST">
            <input type="text" class="task" name="task" id="task" placeholder="Введите товар">
            <button type="submit" name="sendTask" class="btn btn-success bg-dark">Добавить</button>
            </form>
            <?php
            ...
            while($row = $query->fetch(pdo::FETCH_OBJ)){
              echo '<li class="li123"><b class="b123">'.$row->task.'</b><a href="php/delete.php?id='.$row->id.'"><button class="btn-product2">Удалить</button></a></li>';
            }
            echo '</ul>';
    ...
    <footer class="footer">
      <div class="container">
        ...
        <ul class="footer-ul">
          ...
          <a href="#"><li class="li-footer">TAROT CLARAVISIÓN</li></a>
        </ul>
        <div class="ctn2">
